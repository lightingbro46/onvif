...
#include "soapH.h"
    ...
    class SOAP_CMAC AdvancedSecurityServiceBindingProxy {
      public:
        ...
        //
        /// Web service synchronous operation 'SetCertificationPath' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetCertificationPath(_tas__SetCertificationPath *tas__SetCertificationPath, _tas__SetCertificationPathResponse &tas__SetCertificationPathResponse) { return this->SetCertificationPath(NULL, NULL, tas__SetCertificationPath, tas__SetCertificationPathResponse); }
        /// Web service synchronous operation 'SetCertificationPath' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetCertificationPath(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertificationPath *tas__SetCertificationPath, _tas__SetCertificationPathResponse &tas__SetCertificationPathResponse) { return this->send_SetCertificationPath(soap_endpoint_url, soap_action, tas__SetCertificationPath) || this->recv_SetCertificationPath(tas__SetCertificationPathResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetCertificationPath' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_SetCertificationPath(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertificationPath *tas__SetCertificationPath);
        /// Web service asynchronous operation 'recv_SetCertificationPath' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_SetCertificationPath(_tas__SetCertificationPathResponse &tas__SetCertificationPathResponse);
        //
        ...
        //
        /// Web service synchronous operation 'SetCertPathValidationPolicy' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetCertPathValidationPolicy(_tas__SetCertPathValidationPolicy *tas__SetCertPathValidationPolicy, _tas__SetCertPathValidationPolicyResponse &tas__SetCertPathValidationPolicyResponse) { return this->SetCertPathValidationPolicy(NULL, NULL, tas__SetCertPathValidationPolicy, tas__SetCertPathValidationPolicyResponse); }
        /// Web service synchronous operation 'SetCertPathValidationPolicy' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetCertPathValidationPolicy(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertPathValidationPolicy *tas__SetCertPathValidationPolicy, _tas__SetCertPathValidationPolicyResponse &tas__SetCertPathValidationPolicyResponse) { return this->send_SetCertPathValidationPolicy(soap_endpoint_url, soap_action, tas__SetCertPathValidationPolicy) || this->recv_SetCertPathValidationPolicy(tas__SetCertPathValidationPolicyResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetCertPathValidationPolicy' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_SetCertPathValidationPolicy(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertPathValidationPolicy *tas__SetCertPathValidationPolicy);
        /// Web service asynchronous operation 'recv_SetCertPathValidationPolicy' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_SetCertPathValidationPolicy(_tas__SetCertPathValidationPolicyResponse &tas__SetCertPathValidationPolicyResponse);
        //
        ...
        //
        /// Web service synchronous operation 'AddMediaSigningCertificateAssignment' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int AddMediaSigningCertificateAssignment(_tas__AddMediaSigningCertificateAssignment *tas__AddMediaSigningCertificateAssignment, _tas__AddMediaSigningCertificateAssignmentResponse &tas__AddMediaSigningCertificateAssignmentResponse) { return this->AddMediaSigningCertificateAssignment(NULL, NULL, tas__AddMediaSigningCertificateAssignment, tas__AddMediaSigningCertificateAssignmentResponse); }
        /// Web service synchronous operation 'AddMediaSigningCertificateAssignment' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int AddMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__AddMediaSigningCertificateAssignment *tas__AddMediaSigningCertificateAssignment, _tas__AddMediaSigningCertificateAssignmentResponse &tas__AddMediaSigningCertificateAssignmentResponse) { return this->send_AddMediaSigningCertificateAssignment(soap_endpoint_url, soap_action, tas__AddMediaSigningCertificateAssignment) || this->recv_AddMediaSigningCertificateAssignment(tas__AddMediaSigningCertificateAssignmentResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_AddMediaSigningCertificateAssignment' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_AddMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__AddMediaSigningCertificateAssignment *tas__AddMediaSigningCertificateAssignment);
        /// Web service asynchronous operation 'recv_AddMediaSigningCertificateAssignment' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_AddMediaSigningCertificateAssignment(_tas__AddMediaSigningCertificateAssignmentResponse &tas__AddMediaSigningCertificateAssignmentResponse);
        //
        /// Web service synchronous operation 'RemoveMediaSigningCertificateAssignment' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int RemoveMediaSigningCertificateAssignment(_tas__RemoveMediaSigningCertificateAssignment *tas__RemoveMediaSigningCertificateAssignment, _tas__RemoveMediaSigningCertificateAssignmentResponse &tas__RemoveMediaSigningCertificateAssignmentResponse) { return this->RemoveMediaSigningCertificateAssignment(NULL, NULL, tas__RemoveMediaSigningCertificateAssignment, tas__RemoveMediaSigningCertificateAssignmentResponse); }
        /// Web service synchronous operation 'RemoveMediaSigningCertificateAssignment' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int RemoveMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__RemoveMediaSigningCertificateAssignment *tas__RemoveMediaSigningCertificateAssignment, _tas__RemoveMediaSigningCertificateAssignmentResponse &tas__RemoveMediaSigningCertificateAssignmentResponse) { return this->send_RemoveMediaSigningCertificateAssignment(soap_endpoint_url, soap_action, tas__RemoveMediaSigningCertificateAssignment) || this->recv_RemoveMediaSigningCertificateAssignment(tas__RemoveMediaSigningCertificateAssignmentResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_RemoveMediaSigningCertificateAssignment' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_RemoveMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__RemoveMediaSigningCertificateAssignment *tas__RemoveMediaSigningCertificateAssignment);
        /// Web service asynchronous operation 'recv_RemoveMediaSigningCertificateAssignment' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_RemoveMediaSigningCertificateAssignment(_tas__RemoveMediaSigningCertificateAssignmentResponse &tas__RemoveMediaSigningCertificateAssignmentResponse);
        //
        /// Web service synchronous operation 'GetAssignedMediaSigningCertificates' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetAssignedMediaSigningCertificates(_tas__GetAssignedMediaSigningCertificates *tas__GetAssignedMediaSigningCertificates, _tas__GetAssignedMediaSigningCertificatesResponse &tas__GetAssignedMediaSigningCertificatesResponse) { return this->GetAssignedMediaSigningCertificates(NULL, NULL, tas__GetAssignedMediaSigningCertificates, tas__GetAssignedMediaSigningCertificatesResponse); }
        /// Web service synchronous operation 'GetAssignedMediaSigningCertificates' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetAssignedMediaSigningCertificates(const char *soap_endpoint_url, const char *soap_action, _tas__GetAssignedMediaSigningCertificates *tas__GetAssignedMediaSigningCertificates, _tas__GetAssignedMediaSigningCertificatesResponse &tas__GetAssignedMediaSigningCertificatesResponse) { return this->send_GetAssignedMediaSigningCertificates(soap_endpoint_url, soap_action, tas__GetAssignedMediaSigningCertificates) || this->recv_GetAssignedMediaSigningCertificates(tas__GetAssignedMediaSigningCertificatesResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetAssignedMediaSigningCertificates' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetAssignedMediaSigningCertificates(const char *soap_endpoint_url, const char *soap_action, _tas__GetAssignedMediaSigningCertificates *tas__GetAssignedMediaSigningCertificates);
        /// Web service asynchronous operation 'recv_GetAssignedMediaSigningCertificates' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetAssignedMediaSigningCertificates(_tas__GetAssignedMediaSigningCertificatesResponse &tas__GetAssignedMediaSigningCertificatesResponse);
    };
#endif
