...
#include "soapH.h"
    ...
    class SOAP_CMAC Media2BindingProxy {
      public:
        ...
        //
        /// Web service synchronous operation 'GetMulticastAudioDecoderConfigurations' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetMulticastAudioDecoderConfigurations(_ns1__GetMulticastAudioDecoderConfigurations *ns1__GetMulticastAudioDecoderConfigurations, _ns1__GetMulticastAudioDecoderConfigurationsResponse &ns1__GetMulticastAudioDecoderConfigurationsResponse) { return this->GetMulticastAudioDecoderConfigurations(NULL, NULL, ns1__GetMulticastAudioDecoderConfigurations, ns1__GetMulticastAudioDecoderConfigurationsResponse); }
        /// Web service synchronous operation 'GetMulticastAudioDecoderConfigurations' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetMulticastAudioDecoderConfigurations(const char *soap_endpoint_url, const char *soap_action, _ns1__GetMulticastAudioDecoderConfigurations *ns1__GetMulticastAudioDecoderConfigurations, _ns1__GetMulticastAudioDecoderConfigurationsResponse &ns1__GetMulticastAudioDecoderConfigurationsResponse) { return this->send_GetMulticastAudioDecoderConfigurations(soap_endpoint_url, soap_action, ns1__GetMulticastAudioDecoderConfigurations) || this->recv_GetMulticastAudioDecoderConfigurations(ns1__GetMulticastAudioDecoderConfigurationsResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetMulticastAudioDecoderConfigurations' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetMulticastAudioDecoderConfigurations(const char *soap_endpoint_url, const char *soap_action, _ns1__GetMulticastAudioDecoderConfigurations *ns1__GetMulticastAudioDecoderConfigurations);
        /// Web service asynchronous operation 'recv_GetMulticastAudioDecoderConfigurations' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetMulticastAudioDecoderConfigurations(_ns1__GetMulticastAudioDecoderConfigurationsResponse &ns1__GetMulticastAudioDecoderConfigurationsResponse);
        //
        /// Web service synchronous operation 'GetMulticastAudioDecoderConfigurationOptions' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetMulticastAudioDecoderConfigurationOptions(_ns1__GetMulticastAudioDecoderConfigurationOptions *ns1__GetMulticastAudioDecoderConfigurationOptions, _ns1__GetMulticastAudioDecoderConfigurationOptionsResponse &ns1__GetMulticastAudioDecoderConfigurationOptionsResponse) { return this->GetMulticastAudioDecoderConfigurationOptions(NULL, NULL, ns1__GetMulticastAudioDecoderConfigurationOptions, ns1__GetMulticastAudioDecoderConfigurationOptionsResponse); }
        /// Web service synchronous operation 'GetMulticastAudioDecoderConfigurationOptions' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetMulticastAudioDecoderConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _ns1__GetMulticastAudioDecoderConfigurationOptions *ns1__GetMulticastAudioDecoderConfigurationOptions, _ns1__GetMulticastAudioDecoderConfigurationOptionsResponse &ns1__GetMulticastAudioDecoderConfigurationOptionsResponse) { return this->send_GetMulticastAudioDecoderConfigurationOptions(soap_endpoint_url, soap_action, ns1__GetMulticastAudioDecoderConfigurationOptions) || this->recv_GetMulticastAudioDecoderConfigurationOptions(ns1__GetMulticastAudioDecoderConfigurationOptionsResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetMulticastAudioDecoderConfigurationOptions' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetMulticastAudioDecoderConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _ns1__GetMulticastAudioDecoderConfigurationOptions *ns1__GetMulticastAudioDecoderConfigurationOptions);
        /// Web service asynchronous operation 'recv_GetMulticastAudioDecoderConfigurationOptions' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetMulticastAudioDecoderConfigurationOptions(_ns1__GetMulticastAudioDecoderConfigurationOptionsResponse &ns1__GetMulticastAudioDecoderConfigurationOptionsResponse);
        //
        /// Web service synchronous operation 'SetMulticastAudioDecoderConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetMulticastAudioDecoderConfiguration(_ns1__SetMulticastAudioDecoderConfiguration *ns1__SetMulticastAudioDecoderConfiguration, ns1__SetConfigurationResponse &ns1__SetMulticastAudioDecoderConfigurationResponse) { return this->SetMulticastAudioDecoderConfiguration(NULL, NULL, ns1__SetMulticastAudioDecoderConfiguration, ns1__SetMulticastAudioDecoderConfigurationResponse); }
        /// Web service synchronous operation 'SetMulticastAudioDecoderConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetMulticastAudioDecoderConfiguration(const char *soap_endpoint_url, const char *soap_action, _ns1__SetMulticastAudioDecoderConfiguration *ns1__SetMulticastAudioDecoderConfiguration, ns1__SetConfigurationResponse &ns1__SetMulticastAudioDecoderConfigurationResponse) { return this->send_SetMulticastAudioDecoderConfiguration(soap_endpoint_url, soap_action, ns1__SetMulticastAudioDecoderConfiguration) || this->recv_SetMulticastAudioDecoderConfiguration(ns1__SetMulticastAudioDecoderConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetMulticastAudioDecoderConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_SetMulticastAudioDecoderConfiguration(const char *soap_endpoint_url, const char *soap_action, _ns1__SetMulticastAudioDecoderConfiguration *ns1__SetMulticastAudioDecoderConfiguration);
        /// Web service asynchronous operation 'recv_SetMulticastAudioDecoderConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_SetMulticastAudioDecoderConfiguration(ns1__SetConfigurationResponse &ns1__SetMulticastAudioDecoderConfigurationResponse);
    };
#endif
