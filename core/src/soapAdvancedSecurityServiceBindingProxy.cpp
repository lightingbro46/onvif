...
int AdvancedSecurityServiceBindingProxy::send_SetCertificationPath(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertificationPath *tas__SetCertificationPath)
{
	struct __tas__SetCertificationPath soap_tmp___tas__SetCertificationPath;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__SetCertificationPath(soap, &soap_tmp___tas__SetCertificationPath, "-tas:SetCertificationPath", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_SetCertificationPath(_tas__SetCertificationPathResponse &tas__SetCertificationPathResponse)
{
	tas__SetCertificationPathResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__SetCertificationPathResponse.soap_get(soap, "tas:SetCertificationPathResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_SetCertPathValidationPolicy(const char *soap_endpoint_url, const char *soap_action, _tas__SetCertPathValidationPolicy *tas__SetCertPathValidationPolicy)
{
	struct __tas__SetCertPathValidationPolicy soap_tmp___tas__SetCertPathValidationPolicy;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__SetCertPathValidationPolicy(soap, &soap_tmp___tas__SetCertPathValidationPolicy, "-tas:SetCertPathValidationPolicy", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_SetCertPathValidationPolicy(_tas__SetCertPathValidationPolicyResponse &tas__SetCertPathValidationPolicyResponse)
{
	tas__SetCertPathValidationPolicyResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__SetCertPathValidationPolicyResponse.soap_get(soap, "tas:SetCertPathValidationPolicyResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_AddMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__AddMediaSigningCertificateAssignment *tas__AddMediaSigningCertificateAssignment)
{
	struct __tas__AddMediaSigningCertificateAssignment soap_tmp___tas__AddMediaSigningCertificateAssignment;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__AddMediaSigningCertificateAssignment(soap, &soap_tmp___tas__AddMediaSigningCertificateAssignment, "-tas:AddMediaSigningCertificateAssignment", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_AddMediaSigningCertificateAssignment(_tas__AddMediaSigningCertificateAssignmentResponse &tas__AddMediaSigningCertificateAssignmentResponse)
{
	tas__AddMediaSigningCertificateAssignmentResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__AddMediaSigningCertificateAssignmentResponse.soap_get(soap, "tas:AddMediaSigningCertificateAssignmentResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_RemoveMediaSigningCertificateAssignment(const char *soap_endpoint_url, const char *soap_action, _tas__RemoveMediaSigningCertificateAssignment *tas__RemoveMediaSigningCertificateAssignment)
{
	struct __tas__RemoveMediaSigningCertificateAssignment soap_tmp___tas__RemoveMediaSigningCertificateAssignment;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__RemoveMediaSigningCertificateAssignment(soap, &soap_tmp___tas__RemoveMediaSigningCertificateAssignment, "-tas:RemoveMediaSigningCertificateAssignment", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_RemoveMediaSigningCertificateAssignment(_tas__RemoveMediaSigningCertificateAssignmentResponse &tas__RemoveMediaSigningCertificateAssignmentResponse)
{
	tas__RemoveMediaSigningCertificateAssignmentResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__RemoveMediaSigningCertificateAssignmentResponse.soap_get(soap, "tas:RemoveMediaSigningCertificateAssignmentResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_GetAssignedMediaSigningCertificates(const char *soap_endpoint_url, const char *soap_action, _tas__GetAssignedMediaSigningCertificates *tas__GetAssignedMediaSigningCertificates)
{
	struct __tas__GetAssignedMediaSigningCertificates soap_tmp___tas__GetAssignedMediaSigningCertificates;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__GetAssignedMediaSigningCertificates(soap, &soap_tmp___tas__GetAssignedMediaSigningCertificates, "-tas:GetAssignedMediaSigningCertificates", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_GetAssignedMediaSigningCertificates(_tas__GetAssignedMediaSigningCertificatesResponse &tas__GetAssignedMediaSigningCertificatesResponse)
{
	tas__GetAssignedMediaSigningCertificatesResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__GetAssignedMediaSigningCertificatesResponse.soap_get(soap, "tas:GetAssignedMediaSigningCertificatesResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
